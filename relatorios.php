            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-0">Eficiência Média</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
    ...
    <div class="col-12">
        <div class="card border-danger">
            <div class="card-header bg-danger text-white">
                <h5 class="card-title mb-0">
                    <i class="bi bi-exclamation-octagon-fill"></i> Análise de Conflitos de Sala Fixa
                </h5>
            </div>
            <div class="card-body">
...
function criarGraficoEficienciaSala(dados) {
    ...
    chartEficienciaSala = new Chart(canvasElement, {
        ...
        function confirmarExportacao() {
            ...
            const incluirDetalhes = document.getElementById('incluir-detalhes').checked;
            ...
            const params = new URLSearchParams({
                ...
                incluir_detalhes: incluirDetalhes ? '1' : '0'
            });
            
            // Fazer download
            window.open(`api/relatorios.php?${params}`, '_blank');
            
            // Fechar modal
            bootstrap.Modal.getInstance(document.getElementById('modalExportacao')).hide();
        }
// Adicione estas duas funções ao seu <script> em relatorios.php
