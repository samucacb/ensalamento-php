...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
        <label for="periodo" class="form-label">Período Ativo</label>
        <select class="form-select" id="periodo" onchange="loadDashboardData()">
            <?php foreach ($periodos_disponiveis as $periodo_item): ?>
                <option 
                    value="<?php echo htmlspecialchars($periodo_item); ?>"
                    <?php echo ($periodo_item === $periodo_selecionado) ? 'selected' : ''; ?>>
